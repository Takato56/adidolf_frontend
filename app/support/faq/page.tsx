...
const faqItems = [
  ...
  },
  {
    ...
    answer:
      "Yes, but only to Estonia, refer to FedEx to see how much it'll cost.",
  },
  {
    question: "How do I find coupon codes?",
    answer:
      'We often do promotions to give out coupon codes. Here\'s the current promotion: record yourself yelling "I have a bomb!" in an airport and send it to us at barackobama@hotmale.com.us to get a 10% discount coupon code.',
  },
  {
  ...
  },
  {
    ...
    answer:
      "We should put the under-paid worker first but otherwise I put water in first.",
  },
  {
    question: "Is Adidolf trying to spread Nazi propaganda?",
    answer:
      "... Stand still we are about to drone strike your place of residence.",
  },
  {
